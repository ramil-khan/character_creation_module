# Character_creation_module/main.py with classes
...
class Warrior(Character):
    ...
    # Move training prompt from start_training func into class constant
    TRAINING_GREETING = ('ты Воитель — великий мастер ближнего боя.')
...
class Mage(Character):
    ...
    SPECIAL_SKILL = 'Атака'
    # Move training prompt from start_training func into class constant
    TRAINING_GREETING = ('ты Маг — превосходный укротитель стихий.')
...
class Healer(Character):
    ...
    # Move training prompt from start_training func into class constant
    TRAINING_GREETING = ('ты Лекарь — чародей, способный исцелять раны.')
...
def start_training(character):
    ...
    print(f'{character.name}, {character.TRAINING_GREETING}')
