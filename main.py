...
def attack(char_name: str, char_class: str) -> str:
    """Calculate the level of damage done by a character.

    Keyword arguments:
    char_name -- the character name
    char_class -- the class of the character
    """
    damage: int = 0
...
def defence(char_name: str, char_class: str) -> str:
    """Calculate the level of defence by a character.
...
def special(char_name: str, char_class: str) -> str:
    """Calculate the level of skill by a character.
